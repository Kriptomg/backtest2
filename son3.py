...
def backtest_strategy(ohlcv_data, lookback=30, tp_pct=0.02, sl_pct=0.02, hold_bars=5, score_threshold=4):
    ...
    for i in range(lookback, len(closes) - hold_bars):
        ...
        # Senin teknik analiz skor fonksiyonunu çağır:
        try:
            _, score, max_score, *_ = btc_teknik_analiz_raporu(
                curr_ohlcv, closes[i-1], "","",0,1,vade="Backtest")
        except Exception:
            continue
        # Sinyal: Skor belirli bir eşiğin üzerinde ise
